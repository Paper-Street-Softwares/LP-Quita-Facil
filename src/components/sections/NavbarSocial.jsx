        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[30%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[30%] desktop2:w-[30%] transition-all duration-1000"
                  : "my-[10px] w-[50%] tablet1:w-[55%] tablet2:w-[55%] desktop1:w-[60%] desktop2:w-[60%] transition-all duration-1000"
              } tablet3:mb-0`}
            />
          </ScrollLink>
